...
if($_SESSION['otj_adminuser'] && $_SESSION['otj_adminuser_cid'] && $_SESSION['otj_adminuser_uid']){
    if($lib->reset_user_course_data($_SESSION['otj_adminuser_cid'], $_SESSION['otj_adminuser_uid'])){
        ...
        \local_offthejobadmin\event\deleted_user_setup::create(array('context' => \context_course::instance($_SESSION['otj_adminuser_cid']), 'courseid' => $_SESSION['otj_adminuser_cid'], 'relateduserid' => $_SESSION['otj_adminuser_uid']))->trigger();
    } else {
